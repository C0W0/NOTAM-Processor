...
excludeWords = ['BALLOON', 'DRONE', 'KSLV', 'KLSV', 'SHAR RANGE', 'AMERICA', 'LIVE FIRING',
...
firInt = {'Yangon': 'VYYF', 'Chennai': 'VOMF', 'Melbourne': 'YMMM', 'Fukuoka': 'RJJJ', 'Ho-Chi-Minh': 'VVHM', 'Hanoi': 'VVHN', 'Colombo': 'VCCF', 'Manila': 'RPHI',
          'Oakland': 'KZAK', 'Brisbane': 'YBBB', 'InCheon': 'RKRR', 'Nadi': 'NFFF', 'Solomon': 'AGGG', 'Singapore': 'WSJC'}
launchZones = {
    ...
    'Southern Coastal': [firDomestic['Shanghai'], firDomestic['GuangZhou'], firDomestic['Sanya'], firInt['Singapore'], firInt['Melbourne']]
}
regexPatterns = [
    {
